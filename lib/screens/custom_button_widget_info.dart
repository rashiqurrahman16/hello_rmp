...
class CustomButtonWidgetInfo extends StatefulWidget {
  const CustomButtonWidgetInfo(
      {super.key,
      required this.path,
      required this.text,
      this.onTap,
  ...
  @override
  State<CustomButtonWidgetInfo> createState() => _CustomButtonWidgetInfoState();
}

class _CustomButtonWidgetInfoState extends State<CustomButtonWidgetInfo> {
  final GiveInfoController giveInfoController = Get.find<GiveInfoController>();
