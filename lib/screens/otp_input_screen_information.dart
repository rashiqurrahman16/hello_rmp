...
import '/controllers/otp_information_controller.dart';
...
class OtpInputInformationScreen extends StatelessWidget {
  OtpInputInformationScreen({super.key});

  final controller = Get.put(OtpInformationController());
